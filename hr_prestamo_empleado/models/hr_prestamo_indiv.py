...
class HrPayslip(models.Model):
    ...
    def actualiza_descuento(self):
        data_prestamo = self.env['hr.prestamo'].search([('empleado_id', '=', self.employee_id.id),('status_prestamo','=','pending')])
        if data_prestamo:
                ...
                for i in range(cuotas):
                    ...
                    if line_prestamo:
                        ...
                        if cont_solvete==cuotas:
                            ...
                            empleado2 = self.env['hr.employee'].search([('id','=',self.employee_id.id)])
